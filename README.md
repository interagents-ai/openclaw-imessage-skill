...
- `dist/imessage-1.0.4.skill` - installable skill bundle
- `dist/imessage-1.0.4.skill.sha256` - checksum

## Install on another Mac

```bash
mkdir -p ~/.openclaw/skills
unzip -o dist/imessage-1.0.4.skill -d ~/.openclaw/skills
...
```bash
shasum -a 256 dist/imessage-1.0.4.skill
cat dist/imessage-1.0.4.skill.sha256
```
